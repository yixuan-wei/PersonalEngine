...
//////////////////////////////////////////////////////////////////////////
void AudioSystem::SetSoundPaused(SoundPlaybackID soundPlaybackID, bool isPaused)
{
    if (soundPlaybackID == MISSING_SOUND_ID)
    {
        ERROR_RECOVERABLE("WARNING: attempt to stop sound on missing sound playback ID!");
...
//////////////////////////////////////////////////////////////////////////
void AudioSystem::SetSoundPosition(SoundPlaybackID soundPlaybackID, unsigned int posMS)
{
    if (soundPlaybackID == MISSING_SOUND_ID)
    {
        ERROR_RECOVERABLE("WARNING: attempt to stop sound on missing sound playback ID!");
	...
	FMOD::Channel* channelAssignedToSound = (FMOD::Channel*) soundPlaybackID;
	channelAssignedToSound->setPosition(posMS, FMOD_TIMEUNIT_MS);
}
...
//////////////////////////////////////////////////////////////////////////
void AudioSystem::SetSoundCallback(SoundPlaybackID soundPlaybackID, FMOD_CHANNELCONTROL_CALLBACK callback)
{
    if (soundPlaybackID == MISSING_SOUND_ID)
    {
        ERROR_RECOVERABLE("WARNING: attempt to set speed on missing sound playback ID!");
	...
	FMOD::Channel* channelAssignedToSound = (FMOD::Channel*) soundPlaybackID;
	channelAssignedToSound->setCallback(callback);
}
...
//////////////////////////////////////////////////////////////////////////
unsigned int AudioSystem::GetSoundPosition(SoundPlaybackID soundPlaybackID)
{
	unsigned int pos = 0;
    if (soundPlaybackID == MISSING_SOUND_ID)
    {
	...
	FMOD::Channel* channelAssignedToSound = (FMOD::Channel*) soundPlaybackID;
	channelAssignedToSound->getPosition(&pos, FMOD_TIMEUNIT_MS);
	return pos;
}
