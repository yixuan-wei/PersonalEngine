...
public:
	...
	virtual void				SetSoundPaused(SoundPlaybackID soundPlaybackID, bool isPaused);
	virtual void				SetSoundPosition(SoundPlaybackID soundPlaybackID, unsigned int posMS);
	...
	virtual void				SetSoundCallback(SoundPlaybackID soundPlaybackID, FMOD_CHANNELCONTROL_CALLBACK callback);

	virtual void				ValidateResult( FMOD_RESULT result );

	virtual unsigned int		GetSoundPosition(SoundPlaybackID soundPlaybackID); //default to get MS
